...
import argparse
from lib.utils import BM25_B, BM25_K1, DEFAULT_SEARCH_LIMIT
...
def main() -> None:
    ...
    tf_parser.add_argument("doc_id", type=int, help="Document Id to search for term frequency")
    ...
    tfidf_parser.add_argument("doc_id", type=int, help="Document Id to calculate term tf-idf")
    ...
    bm25search_parser.add_argument("limit", type=int, nargs='?', default=DEFAULT_SEARCH_LIMIT, help="Limit of returned relevant documents")
